  ...
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-xl rounded-2xl border border-gray-200 bg-white shadow-sm p-6 md:p-8 text-center">
        <p className="text-sm font-semibold text-[#FC8019]">404</p>
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-3">
          {inAdmin ? (
            <Button className="w-full sm:w-auto bg-[#FC8019] hover:bg-[#ea7310]" onClick={() => navigate("/admin")}>
              <ArrowLeft className="w-4 h-4 mr-2" />
              Back to Admin
            </Button>
          ) : (
            <Button className="w-full sm:w-auto bg-[#FC8019] hover:bg-[#ea7310]" onClick={() => navigate("/")}>
