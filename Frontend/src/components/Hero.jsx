...
const Hero = () => {
  return (
    <section className="relative overflow-hidden bg-[#070c17] pb-14 pt-24 md:pb-20 md:pt-28">
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -left-1/4 top-[-45%] h-[88%] w-[56%] rounded-full bg-[#02050c] blur-3xl" />
        <div
